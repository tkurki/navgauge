...
if (exports) {
  ...
  exports.metersPerSecond2knots = function (mps) {
    return mps / 0.514444;
  };

  var fromN2KDate = function(canboatDate) {
    //Sun Mar 30 2014 16:20:01 GMT+0300 (EEST)
    return canboatDate + 'FIXDATE';
  }
  exports.fromN2KDate = fromN2KDate;

    exports.n2kSource = function(msg) {
    return {
      type: 'n2k',
        id: 'ngt1',
      src: msg.src,
      pgn: msg.pgn,
      timestamp: fromN2KDate(msg.timestamp)
    }
  }
}
