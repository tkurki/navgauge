...
exports.create = function (infilename, n2k, nmea, hasActiveClients) {
    var rd;
    var messages = [];
    var readerDone = false;
    var filename = infilename;
    var hasSomebodyListening;

  hasActiveClients.onValue(function(value) {
    hasSomebodyListening = value;
  });
