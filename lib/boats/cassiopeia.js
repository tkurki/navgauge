...
exports.boat = {
  configureStreams: function (streams) {
    ...
    /* { type: 'nav-info',
     ...
     variationPole: 'E',
     talker_id: 'II' }*/
    var navInfo = streams.nmea.json.filter(function (msg) {
      return msg.type === 'nav-info'
    });
    streams.nmea.raw.plug(navInfo.map(function (msg) {
      return nmea.encode('XX',{
        type: 'track-info',
        trackTrue: msg.trackTrue,
        trackMagnetic: 0,
    ...
    streams.gaugeData.plug(navInfo.flatMap(function (msg) {
