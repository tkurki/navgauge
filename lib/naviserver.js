...
exports.startApp = function () {
  ...
  primus.on('connection', function (spark) {
    ...
    if (spark.query['treedata'] != undefined) {
      try {
        spark['unsubscribe'].push(streamSources.treeData.createStreamWithConfiguration(spark.query['treedata']).subscribe(function (event) {
          spark.write(event.value());
        }));
      } catch (e) {
    ...
    streamSources.treeData.getTypeStream('navigation.depth').push({foo:'bar'});
  });
